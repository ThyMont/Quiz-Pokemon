...
public class TQuizSombras extends JInternalFrame {
	...
	public TQuizSombras(JDesktopPane desktop, Treinador treinador) {
		setBorder(null);
		...
		lblTituloquiz.setText("Quiz - Sombras");
	...
	public void respostaCorreta(String nomeTreinador) {
		...
		ImageIcon icon = new ImageIcon((new ImageIcon(TCadastroTreinador.class.getResource("/images/pokeballIcon.png")))
			.getImage().getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH));
		JOptionPane.showMessageDialog(null, "Você Acertou!!!", "=D", JOptionPane.INFORMATION_MESSAGE, icon);
		refresh();
		preencherQuiz();
